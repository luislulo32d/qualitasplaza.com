                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7 align-self-center g-color-white">
                        <div class="g-px-50--lg">
                         ...
                         REQUEST A FREE DIAGNOSIS.</h2>
                          <p class="lead g-color-white-opacity-0_8 g-mb-35">Get a demo for your online business without cost and without commitment. It is possible to deliver the results in a short meeting or phone call.</p>
                        </div>
                      </div>
...
<!-- Form Name -->
<legend>Online diagnosis - Free DEMO</legend>
<p class="agile-form-description"></p>
<div style="display: none; height: 0px; width: 0px;">
<input type="hidden" id="_agile_form_name" name="_agile_form_name" value="Online diagnosis - Free DEMO">
...
<input type="hidden" id="_agile_form_id_tags" name="tags" value="diagosticomaineng">

<input type="hidden" id="_agile_form_id" name="_agile_form_id" value="5687196396814336">
</div>
<!-- Text input-->
...
<div class="agile-group">
  ...
  <div class="agile-field agile-button-field">
    <button type="submit" class="agile-button">Request diagnosis</button>
