...
<head>
  <!-- Title -->
  <title>Qualitas Plaza - Gracias por la confirmación</title>
  <link rel="canonical" href="https://qualitasplaza.com/gracias-confirmacion.html">
  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall "
      ...
      <div class="container g-color-white text-center g-py-120">
        <h3 class="h1 g-font-weight-600 text-uppercase mb-2">Confirmación - Solicitud de demo</h3>
      ...
      <div class="row justify-content-center g-mb-60">
        <div class="col-lg-7">
          ...
          <div class="text-center">
            ...
            <p class="mb-0">Enviaremos a tu Email los detalles sobre la entrega del diagnóstico DEMO de tu Sitio Web.
            </p>
            <br>
