...
<body>
  <main>
    ...
    <section class="js-carousel" data-infinite="true" data-pagi-classes="g-absolute-centered--x g-bottom-30">
      <div class="js-slide g-min-height-600 g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after" style="background-image: url(assets/img-temp/registro.jpg);">
        <!-- Promo Block Content -->
        <div class="g-flex-centered-item g-py-100" data-calc-target="#js-header">
          <div class="container g-bg-cover__inner">
            <h2 class="h2 g-color-white g-font-weight-600 g-font-size-40 g-font-size-65--md text-uppercase g-line-height-1_2 g-letter-spacing-1 g-mb-40">Access to
              <br> <span class="g-font-weight-700">Qualitas Plaza</span></h2>
