...
<head>
  <!-- Title -->
  <title>Qualitas Plaza - Gracias por la cotización</title>
  <link rel="canonical" href="https://qualitasplaza.com/gracias-cotizacion.html">
  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall "
      ...
      <div class="container g-color-white text-center g-py-120">
        <h3 class="h1 g-font-weight-600 text-uppercase mb-2">Confirmación - Solicitud de cotización</h3>
      </div>
      <!-- Promo Block Content -->
    </section>
    <!-- End Promo Block -->
      ...
      <div class="row justify-content-center g-mb-60">
        <div class="col-lg-7">
          ...
          <div class="text-center">
            ...
            <p class="mb-0">Hemos recibido con éxito tu solicitud de cotización. Enviaremos a tu email el presupuesto
              que mejor se adapte a tu negocio.</p>
            <br>
