...
<head>
  ...
  <link rel="canonical" href="https://qualitasplaza.com/panel_en.html">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7 align-self-center g-color-white">
                        <div class="g-px-50--lg">
                         ...
                         REQUEST YOUR BUDGET FOR ADVANCED BUSINESS PANEL.</h2>
                          <p class="lead g-color-white-opacity-0_8 g-mb-35">Send us your information and we will respond as soon as possible.</p>
                        </div>
                      </div>
...
<!-- Form Name -->
<legend>Get a Quote - Business Panel</legend>
<p class="agile-form-description"></p>
<div style="display: none; height: 0px; width: 0px;">
<input type="hidden" id="_agile_form_name" name="_agile_form_name" value="Get a Quote - Business Panel">
...
<input type="hidden" id="_agile_form_id_tags" name="tags" value="cotizacion-panel-eng">

<input type="hidden" id="_agile_form_id" name="_agile_form_id" value="5658229996519424">
</div>
<!-- Text input-->
...
<p class="agile-text-element" style="text-align:left ;font-size:14px ">Tell us about your project</p>
</div>


<!-- Textarea -->
<div class="agile-group">
  <label class="agile-label" for="agilefield-5">Tell us about your project:</label>
  <div class="agile-field-xlarge agile-field">
    <textarea maxlength="250" id="agilefield-5" name="note" placeholder="" class="agile-height-default"></textarea>
  </div>
  <div class="agile-custom-clear"></div>
</div>
...
<div class="agile-group">
  ...
  <div class="agile-field agile-button-field">
    <button type="submit" class="agile-button">Get a quote</button>
