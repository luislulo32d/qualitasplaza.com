  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall "
      ...
      <div class="container g-color-white text-center g-py-120">
        <h3 class="h1 g-font-weight-600 text-uppercase mb-2">Programmers</h3>
        <p class="g-font-weight-300 g-font-size-22 text-uppercase">Register now</p>
      </div>
      <!-- Promo Block Content -->
    </section>
    <!-- End Promo Block -->
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="u-heading-v2-3--bottom g-brd-primary g-mb-30">
              <h2 class="h3 text-uppercase g-font-weight-300 u-heading-v2__title">Specially designed for webmasters,
                freelancers, and business clusters.</h2>
            </div>
            <p class="lead">Also ideal for entrepreneurs and consultants as it facilitates greater sales by ensuring the
              quality of their service at delivery.</p>
          </div>

          <div class="col-md-6">
            <center>
              <img class="img-fluid" src="assets/img-temp/others/programmers.jpg" width="80%" alt="Image Description">
            </center>
          </div>
        </div>
      </div>
      ...
      <div class="shortcode-html g-mt-100">
        ...
        <div class="row">
          <div class="col-lg-6 g-pb-40">
            ...
            <span class="d-block g-color-primary g-font-weight-300 g-font-size-20 g-mb-30">Exclusive agreement for
              programmers.</span>
            <div class="row">
          ...
          <div class="col-lg-7 align-self-center g-color-white">
            <div class="g-px-50--lg">
              <h2
                ...
                REQUEST A QUALITY LEADERS LICENSE FILLING THE FORM.</h2>
              <p class="lead g-color-white-opacity-0_8 g-mb-35">Sign up to enter the special program and get the
                benefits of the service.</p>
            </div>
          </div>
                ...
                <fieldset>
                  ...
                  <div style="display: none; height: 0px; width: 0px;">
                    ...
                    <input type="hidden" id="_agile_redirect_url" name="_agile_redirect_url"
                      value="https://qualitasplaza.com/thanks-confirmation.html">
                    <input type="hidden" id="_agile_document_url" name="_agile_document_url" value="">
                    <input type="hidden" id="_agile_confirmation_msg" name="_agile_confirmation_msg" value="">
                    <input type="hidden" id="_agile_form_id_tags" name="tags" value="programador-eng">

                    <input type="hidden" id="_agile_form_id" name="_agile_form_id" value="5680464471785472">
                  </div>
                  <!-- Text input-->
                  ...
                  <div class="agile-group">
                    <p class="agile-text-element" style="text-align:left ;font-size:13px "> Enter the URLs where you
                      want to apply the program.</p>
                  </div>


                  <!-- Prepended text-->
                  <div class="agile-group required-control">
                    <label class="agile-label" for="agilefield-3">Website 1<span class="agile-span-asterisk">
                        *</span></label>
                    <div class="agile-field-xlarge agile-field">
                      <div class="agile-input-group">
                        <span class="agile-group-addon">URL</span>
                        <input maxlength="250" id="agilefield-3" name="website"
                          class="agile-field-xlarge agile-height-default" placeholder="Enter URL" type="text"
                          required="">
                      </div>
                    </div>
                    <div class="agile-custom-clear"></div>
                  ...
                  <div class="agile-group">
                    ...
                    <div class="agile-field-xlarge agile-field">
                      <div class="agile-input-group">
                        <span class="agile-group-addon">URL</span>
                        <input maxlength="250" id="agilefield-4" name="note"
                          class="agile-field-xlarge agile-height-default" placeholder="Enter URL" type="text">
                      </div>
                    </div>
                    <div class="agile-custom-clear"></div>
                  ...
                  <div class="agile-group">
                    ...
                    <div class="agile-field-xlarge agile-field">
                      <div class="agile-input-group">
                        <span class="agile-group-addon">URL</span>
                        <input maxlength="250" id="agilefield-5" name="note"
                          class="agile-field-xlarge agile-height-default" placeholder="Enter URL" type="text">
                      </div>
                    </div>
                    <div class="agile-custom-clear"></div>
                  ...
                  <div class="agile-group">
                    <p class="agile-text-element" style="text-align:center ;font-size:11px ">In compliance with Data
                      Protection Law, we inform you that you have the right to withdraw your consents at any time, as
                      well as to oppose the treatment, limit it, access, rectify, delete data and exercise your right to
                      portability, through the email info@qualitasplaza.com.</p>
                  </div>
