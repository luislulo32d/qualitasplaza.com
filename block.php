  ...
  <main>
    ...
    <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall"
      ...
      <div class="divimage dzsparallaxer--target w-100 g-bg-cover g-bg-black-opacity-0_3--after"
        style="height: 120%; background-image: url(assets/img-temp/contacto.jpg);"></div>
      ...
      <div class="container g-pt-170">
        <div class="row justify-content-between align-items-center">
          <div class="col-md-6 col-lg-7 g-mb-90">
            <!-- Content Info -->
            <div class="mb-5">
              <h1 class="g-color-white g-font-weight-600 g-font-size-50 mb-3">Panel no disponible.</h1>
              <p class="g-color-white g-font-size-18 g-line-height-2">Tu período de prueba ha finalizado. Contacta a
                nuestros expertos para evaluar tus necesidades. Te enviaremos una propuesta que se adapte a los
          ...
          <div class="col-md-6 col-lg-4 g-mb-90">
            ...
            <form class="g-bg-white rounded g-px-30 g-py-40">
              <div class="text-center">
                <h2 class="h3 g-font-weight-600 g-mb-35">Ingreso a panel</h2>
              </div>

              <input class="form-control rounded g-px-20 g-py-12 mb-3" type="email" placeholder="Email">
              <input class="form-control rounded g-px-20 g-py-12 mb-3" type="text" placeholder="Contraseña">

              <div class="g-mb-35">
                <center>
                  <button type="button" class="btn btn-primary btn-lg btn-block g-mr-10 g-mb-15">Enviar</button>
                </center>
              </div>
