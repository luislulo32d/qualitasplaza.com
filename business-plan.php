...
<head>
  <!-- Title -->
  <title>Qualitas Plaza - Business Plan</title>
  <link rel="canonical" href="https://qualitasplaza.com/business-plan.php">
            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
              ...
              <ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
                ...
                <!-- End Contacto -->
                 <!-- Blog -->
                <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                  <a href="https://www.linkedin.com/company/qualitas-plaza/about/" class="nav-link g-py-7 g-px-0">Blog</a>
                </li>
                <!-- End Blog -->
              </ul>
            </div>
            ...
            <div class="shortcode-html g-mt-100">
              ...
              <div class="row">
                <div class="col-lg-6 g-pb-40">
                  <h2 class="h3 g-font-weight-600 text-uppercase mb-0">Business plan.</h2>
                  <span class="d-block g-color-primary g-font-weight-300 g-font-size-20 g-mb-30">Free trial - services by default.</span>
                  <div class="row">
                ...
                <div class="col-lg-6 g-pb-40">
                  ...
                  <div class="media g-mb-20">
                    <div class="d-flex mr-4">
                      <h3 class="h5 g-mb-5">Includes:</h3>
                    </div>
                  ...
                  <div class="media g-mb-20">
                    ...
                    <div class="media-body">
                      <h3 class="h5 g-mb-5">Web Quality Module</h3>
                      <p class="g-color-gray-dark-v4">- Web Tech Diagnostics <br>- Web quality validation</p>
                    </div>
                  </div>
                  <!-- End Icon Blocks -->
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h3 class="h5 g-mb-5">e-Commerce Module</h3>
                      <p class="g-color-gray-dark-v4">- Best practices audit <br>- Best Practices Accreditation</p>
                    </div>
                  </div>
                  <!-- End Icon Blocks -->
                </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7 align-self-center g-color-white">
                        <div class="g-px-50--lg">
                          <h2 class="g-color-white g-font-weight-600 g-font-size-30 g-font-size-50--md text-uppercase g-line-height-1_2 g-mb-20">
                         REQUEST A TRIAL OF BUSINESS PLAN.</h2>
                          <p class="lead g-color-white-opacity-0_8 g-mb-35">Sign up to enter the special program and get the benefits of this service.</p>
                        </div>
                      </div>
...
<input type="hidden" id="_agile_form_id" name="_agile_form_id" value="5640079934488576">
</div>
<!-- Text input-->
...
<div class="agile-group">
  ...
  <div class="agile-field-xlarge agile-field">
	<input maxlength="250" id="agilefield-4" name="last_name" type="text" placeholder="Last name" class="agile-height-default">
  </div>
  <div class="agile-custom-clear"></div>
</div>
<!-- Text input-->
...
<!-- Prepended text-->
<div class="agile-group required-control">
  <label class="agile-label" for="agilefield-3"> Enter the URL where you want to apply the plan<span class="agile-span-asterisk"> *</span></label>
  <div class="agile-field-xlarge agile-field">
...
<div class="agile-group">
  ...
  <div class="agile-field agile-button-field">
    <button type="submit" class="agile-button">Request demo</button>
...
(function(a){var b=a.onload,p=false;isCaptcha=true;if(p){a.onload="function"!=typeof b?function(){try{_agile_load_form_fields()}catch(a){}}:function(){b();try{_agile_load_form_fields()}catch(a){}}};var formLen=document.forms.length;for(i=0;i<formLen;i++){if(document.forms.item(i).getAttribute("id")== "agile-form"){a.document.forms.item(i).onsubmit=function(a){a.preventDefault();try{_agile_synch_form_v5(this)}catch(b){this.submit()}}}}})(window);
                          ...
                          <br>
                          <h3 class="h6 g-color-gray text-center g-font-size-10">In compliance with the Data Protection Law, we inform you that you have the right to withdraw your consents at any time, as well as to oppose the treatment, limit it, access, rectify, delete the data and exercise your right to portability, through the email info@qualitasplaza.com.</h3>
              ...
              <div class="container g-mb-60">
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                    ...
                    <div class="g-mb-30">
                      <p>Validate and improve your online business experience.</p>
                    </div>
                      ...
                      <p>Subscribe to our newsletter and stay up to date with the latest news and offers!</p>
                       <div class="input-group border-0 g-rounded-30">
                        <div class="input-group-addon border-0 p-0">
                         <button type="button" class="btn btn-sm u-btn-primary g-rounded-30 g-px-12 g-py-8" data-toggle="modal" data-target="#myModal1-12">
                            Subscribe
                            </button>
                        </div>
                      </div>
