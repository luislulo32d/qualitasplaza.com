  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall "
      ...
      <div class="container g-color-white text-center g-py-120">
        ...
        <p class="g-font-weight-300 g-font-size-22 text-uppercase">Get access to multiple tools in one service.</p>
      </div>
      <!-- Promo Block Content -->
    </section>
    <!-- End Promo Block -->
    ...
    <section class="container g-pt-50 g-pb-50">
      <div class="row justify-content-center g-mb-60">
        <div class="col-lg-7">
          ...
          <div class="text-center">
            <h2 class="h3 text-uppercase mb-2">We are Qualitas Plaza</h2>
            <div class="d-inline-block g-width-35 g-height-2 g-bg-primary mb-2"></div>
            <p class="mb-0">We provide a complete solution to guarantee and control the Digital Customer Experience,
              including Users Experience, technical quality factors and e-Commerce Best Practices.</p>
          </div>
          <!-- End Heading -->
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="mb-5">
            <p class="g-mb-30">More than 80% of SMB websites have service problems, code errors, low standards without
              ease of use and functionality, email failures and non-existent frameworks. This can be solved by
              implementing clear rules for the different factors that affect sales:</p>
            <div class="row">
              <div class="col-sm-6">
    ...
    <section class="container g-pt-20">
      <div class="row justify-content-center g-mb-60">
        <div class="col-lg-7">
          <!-- Heading -->
          <div class="text-center">
            <h2 class="h3 text-uppercase mb-2">Meet our team</h2>
            <div class="d-inline-block g-width-35 g-height-2 g-bg-primary mb-2"></div>
            <p class="lead mb-0">Our team is composed of committed professionals in different business
              sectors.</p>
          </div>
          <!-- End Heading -->
        </div>
            ...
            <figcaption class="u-block-hover__additional--partially-slide-up g-mx-15">
              <div class="text-center g-bg-white g-pb-20">
                ...
                <div class="u-block-hover__visible g-pt-20 g-pb-15 g-y-20">
                  ...
                  <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Web
                    developer</em>
                </div>
                <!-- End Info -->
              </div>
      ...
      <div class="container g-pt-50 g-pb-10">
        <div class="row justify-content-center g-mb-60">
          <div class="col-lg-7">
            <!-- Heading -->
            <div class="text-center">
              <h2 class="h3 text-uppercase mb-2">Accelerators - sponsorships</h2>
              <div class="d-inline-block g-width-35 g-height-2 g-bg-primary mb-2"></div>
            </div>
            <!-- End Heading -->
          </div>
      ...
      <div class="container g-pt-50 g-pb-10">
        <div class="row justify-content-center g-mb-60">
          <div class="col-lg-7">
            <!-- Heading -->
            <div class="text-center">
              <h2 class="h3 text-uppercase mb-2">Our mission</h2>
              <div class="d-inline-block g-width-35 g-height-2 g-bg-primary mb-2"></div>
              <p class="mb-0">Our approach is to democratize and facilitate assurrance with Customer Experience and
                compliance with standards that directly affect sales.</p>
            </div>
            <!-- End Heading -->
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 g-mb-30">
            <div class="mb-5">
              <p>To carry out our mission we have formed a multidisciplinary team of professionals providing support in
                different areas of business such as project management, web design, web development, neuromarketing,
                among other fields of digital technology.</p>
              <p>Additionally, we are building synergies with clusters, companies and specialists to join us or work
        ...
        <div class="row">
          <div class="col-lg-4 g-mb-30">
            ...
            <div class="text-center">
              ...
              <h3 class="h5 text-uppercase mb-3">Optimization</h3>
              <p>Get our support for boosting the website performance and controlling the quality of your investment.
              </p>
            </div>
            <!-- End Icon Blocks -->
          </div>
          ...
          <div class="col-lg-4 g-mb-30">
            ...
            <div class="text-center">
              ...
              <h3 class="h5 text-uppercase mb-3">Commitment</h3>
              <p>We verify compliance with standards through seals with a technical web and online sales certification.
              </p>
            </div>
            <!-- End Icon Blocks -->
          </div>
          ...
          <div class="col-lg-4 g-mb-30">
            ...
            <div class="text-center">
              ...
              <h3 class="h5 text-uppercase mb-3">Loyalty</h3>
              <p>We are committed with a honnest and objective service for helping our clients without any conflict of
                interest.</p>
            </div>
            <!-- End Icon Blocks -->
          </div>
    ...
    <div class="text-center">
      <h2 class="h3 text-uppercase mb-2">Our Clients</h2>
      <div class="d-inline-block g-width-35 g-height-2 g-bg-primary mb-2"></div>
    </div>
    ...
    <div class="container g-pb-80 g-pt-20">
      <div class="js-carousel" data-infinite="true" data-autoplay="true" data-slides-show="4" data-responsive='[{
        ...
        <div class="js-slide u-block-hover">
          <img
            class="mx-auto g-width-200 u-block-hover__main--grayscale g-opacity-0_3 g-opacity-1--hover g-cursor-pointer"
        ...
        <div class="js-slide u-block-hover">
          <img
            class="mx-auto g-width-200 u-block-hover__main--grayscale g-opacity-0_3 g-opacity-1--hover g-cursor-pointer"
            src="assets/img-temp/clients_logos/client7.svg" alt="Image description">
        </div>
      </div>
    </div>
    <!-- End Clients -->
