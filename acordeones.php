        ...
        <div class="u-sidebar-navigation-inner">
          ...
          <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-accordions.php" class="nav-link active">Accordions</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-alerts.php" class="nav-link ">Alerts</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-badges.php" class="nav-link ">Badges</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-blockquotes.php" class="nav-link ">Blockquotes</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-box-shadows.php" class="nav-link ">Box Shadow</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-breadcrumbs.php" class="nav-link ">Breadcrumbs</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-buttons.php" class="nav-link ">Buttons</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-dividers.php" class="nav-link ">Dividers</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-modals.php" class="nav-link ">Modals</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-gradient-backgrounds.php" class="nav-link ">Gradient Backgrounds</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-labels.php" class="nav-link ">Labels</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-lists-group.php" class="nav-link ">Lists Group</a>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-media-audios.php" class="nav-link ">Media Audios</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-media-images.php" class="nav-link ">Media Images</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-media-videos.php" class="nav-link ">Media Videos</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-onscroll-animations.php" class="nav-link ">Onscroll Animations</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-paginations.php" class="nav-link ">Paginations</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-panels.php" class="nav-link ">Panels</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-progress-bars.php" class="nav-link ">Progress Bars</a>
            </li>
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-base-dynamic-process-blocks-1.php" class="nav-link ">Dynamic Process Blocks</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-base-static-process-blocks-1.php" class="nav-link ">Static Process Blocks</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-tables.php" class="nav-link ">Tables</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-taglines.php" class="nav-link ">Taglines</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-tags.php" class="nav-link ">Tags</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-headings.php" class="nav-link ">Headings</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-typography.php" class="nav-link ">Typography</a>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/shortcode-base-dropcaps.php" class="nav-link ">Dropcaps</a>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-google-maps.php" class="nav-link ">Google Maps</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-vector-maps.php" class="nav-link ">Vector Maps</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/shortcode-base-maps-with-pins.php" class="nav-link ">Maps With Pins</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown bases blocks">
              <a class="nav-link dropdown-toggle " href="#!" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Forms</a>
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/forms/shortcode-base-forms-bootstrap.php" class="nav-link ">Forms Bootstrap</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/forms/shortcode-base-forms-unify.php" class="nav-link ">Forms Unify</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/forms/shortcode-base-form-layouts.php" class="nav-link ">Form Layouts</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/forms/shortcode-base-forms-horizontal-unify.php" class="nav-link ">Forms Horizontal Unify</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/forms/shortcode-base-forms-disabled-states-unify.php" class="nav-link ">Forms Disabled States Unify</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/forms/shortcode-base-forms-success-states-unify.php" class="nav-link ">Forms Success States Unify</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/forms/shortcode-base-forms-error-states-unify.php" class="nav-link ">Forms Error States Unify</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown bases">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-icons.php" class="nav-link ">Icons</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-icon-hovers.php" class="nav-link ">Icon Hovers</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-icon-sizes.php" class="nav-link ">Icon Sizes</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-social-icons.php" class="nav-link ">Social Icons</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-icon-fontawesome.php" class="nav-link ">Icon Fontawesome</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-icon-material.php" class="nav-link ">Material Icons</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-icon-line-icons-pro-1.php" class="nav-link ">Icon Line Icons Pro 1</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-icon-line-icons-pro-2.php" class="nav-link ">Icon Line Icons Pro 2</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-icon-simple-line-icons.php" class="nav-link ">Icon Simple Line Icons</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item bases">
                    <a href="../../unify-main/shortcodes/icons/shortcode-base-icon-et-line-icon.php" class="nav-link ">Icon Et Line Icon</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item bases">
              <a href="../../unify-main/shortcodes/tabs/index.php" class="nav-link ">Tabs</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/portfolios/index.php" class="nav-link ">Portfolios</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/headers/index.php" class="nav-link ">Headers</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/promo/index.php" class="nav-link ">Promo</a>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/footers/shortcode-blocks-footer-classic.php" class="nav-link ">Footer Classic</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/footers/shortcode-blocks-footer-contact-forms.php" class="nav-link ">Footer Contact Forms</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/footers/shortcode-blocks-footer-maps.php" class="nav-link ">Footer Maps</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/footers/shortcode-blocks-footer-modern.php" class="nav-link ">Footer Modern</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-banners.php" class="nav-link ">Banners</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-clients.php" class="nav-link ">Clients</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-comments.php" class="nav-link ">Comments</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-countdowns.php" class="nav-link ">Countdowns</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-counters.php" class="nav-link ">Counters</a>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-cta-boxed.php" class="nav-link ">Call To Action (boxed)</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-cta-full-width.php" class="nav-link ">Call To Action (full width)</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              <a class="nav-link dropdown-toggle " href="#!" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Galleries &amp; Lightboxes</a>
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-gallery-grid.php" class="nav-link ">Gallery Grid</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-gallery-fullwidth.php" class="nav-link ">Gallery Fullwidth</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-gallery-carousel.php" class="nav-link ">Gallery Carousel</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-base-gallery-grid-layouts.php" class="nav-link ">Gallery Grid Layouts</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-base-lightbox-options.php" class="nav-link ">Lightbox Options</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-hero-info.php" class="nav-link ">Hero Info</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-hero-blocks.php" class="nav-link ">Hero Blocks</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-hero-content.php" class="nav-link ">Hero Content</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-icons.php" class="nav-link ">Icon Blocks</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-icons-app.php" class="nav-link ">Icons App</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-icons-interactive.php" class="nav-link ">Icons Interactive</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-info-blocks.php" class="nav-link ">Info Blocks</a>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-news.php" class="nav-link ">News</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-news-image.php" class="nav-link ">News Image</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-news-no-images.php" class="nav-link ">News Without Images</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-news-small.php" class="nav-link ">News Small</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-tables.php" class="nav-link ">Table Designs</a>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-pricing-plans.php" class="nav-link ">Pricing Plans</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-pricing-sections.php" class="nav-link ">Pricing Sections</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-pricing-table.php" class="nav-link ">Pricing Table</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-products.php" class="nav-link ">Products</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-products-advanced.php" class="nav-link ">Products Advanced</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-products-list.php" class="nav-link ">Products List</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-products-overlay.php" class="nav-link ">Products Overlay</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-team.php" class="nav-link ">Team</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-team-advanced.php" class="nav-link ">Team Advanced</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item dropdown blocks">
              ...
              <div class="dropdown-menu u-dropdown-static">
                <ul class="nav flex-column">
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-testimonials.php" class="nav-link ">Testimonials</a>
                  </li>
                  <li class="js-shortcode-filter__item nav-item blocks">
                    <a href="../../unify-main/shortcodes/shortcode-blocks-testimonials-advanced.php" class="nav-link ">Testimonials Advanced</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-timelines.php" class="nav-link ">Timelines</a>
            </li>
            <li class="js-shortcode-filter__item nav-item blocks">
              <a href="../../unify-main/shortcodes/shortcode-blocks-users.php" class="nav-link ">Users</a>
            </li>
          </ul>
                    ...
                    <div class="card g-brd-none rounded-0 g-mb-15">
                      <div id="accordion-11-heading-02" class="u-accordion__header g-pa-0" role="tab">
                        <h5 class="mb-0">
                          ...
                          <a class="collapsed d-flex g-color-main g-text-underline--none--hover g-brd-around g-brd-gray-light-v4 g-rounded-5 g-pa-10-15" href="#accordion-11-body-02" aria-expanded="false" aria-controls="accordion-11-body-02"
                    ...
                    <div class="card g-brd-none rounded-0 g-mb-15">
                      <div id="accordion-11-heading-03" class="u-accordion__header g-pa-0" role="tab">
                        <h5 class="mb-0">
                          ...
                          <a class="collapsed d-flex g-color-main g-text-underline--none--hover g-brd-around g-brd-gray-light-v4 g-rounded-5 g-pa-10-15" href="#accordion-11-body-03" aria-expanded="false" aria-controls="accordion-11-body-03"
                    ...
                    <div class="card g-brd-none rounded-0 g-mb-15">
                      <div id="accordion-12-heading-02" class="u-accordion__header g-pa-0" role="tab">
                        <h5 class="mb-0">
                          ...
                          <a class="collapsed d-flex g-color-main g-text-underline--none--hover g-brd-around g-brd-gray-light-v4 g-rounded-5 g-pa-10-15" href="#accordion-12-body-02"
                    ...
                    <div class="card g-brd-none rounded-0 g-mb-15">
                      <div id="accordion-12-heading-03" class="u-accordion__header g-pa-0" role="tab">
                        <h5 class="mb-0">
                          ...
                          <a class="collapsed d-flex g-color-main g-text-underline--none--hover g-brd-around g-brd-gray-light-v4 g-rounded-5 g-pa-10-15" href="#accordion-12-body-03"
                      ...
                      <div class="card rounded-0 g-mb-5">
                        <div id="accordion-03-heading-01" class="u-accordion__header" role="tab">
                          <h5 class="mb-0">
                            ...
                            <a class="d-flex u-link-v5 g-color-main g-color-primary--hover g-font-size-16 " href="#accordion-03-body-01"
                        ...
                        <div id="accordion-03-body-01" class="collapse show" role="tabpanel" aria-labelledby="accordion-03-heading-01" data-parent="#accordion-03">
                      ...
                      <div class="card rounded-0 g-mb-5">
                        <div id="accordion-03-heading-02" class="u-accordion__header" role="tab">
                          <h5 class="mb-0">
                            ...
                            <a class="collapsed d-flex u-link-v5 g-color-main g-color-primary--hover g-font-size-16 " href="#accordion-03-body-02"
                      ...
                      <div class="card rounded-0 g-mb-5">
                        <div id="accordion-03-heading-03" class="u-accordion__header" role="tab">
                          <h5 class="mb-0">
                            ...
                            <a class="collapsed d-flex u-link-v5 g-color-main g-color-primary--hover g-font-size-16 " href="#accordion-03-body-03"
                      ...
                      <div class="card rounded-0 g-mb-5">
                        <div id="accordion-04-heading-01" class="u-accordion__header" role="tab">
                          <h5 class="mb-0 g-font-weight-300">
                            ...
                            <a class="d-flex u-link-v5 g-color-main g-color-primary--hover g-font-size-16" href="#accordion-04-body-01"
                      ...
                      <div class="card rounded-0 g-mb-5">
                        <div id="accordion-04-heading-02" class="u-accordion__header" role="tab">
                          <h5 class="mb-0 g-font-weight-300">
                            ...
                            <a class="d-flex collapsed u-link-v5 g-color-main g-color-primary--hover g-font-size-16" href="#accordion-04-body-02"
                      ...
                      <div class="card rounded-0 g-mb-5">
                        <div id="accordion-04-heading-03" class="u-accordion__header" role="tab">
                          <h5 class="mb-0 g-font-weight-300">
                            ...
                            <a class="d-flex collapsed u-link-v5 g-color-main g-color-primary--hover g-font-size-16" href="#accordion-04-body-03"
                    ...
                    <div class="card rounded-0 g-bg-primary-dark-v2 g-color-white g-brd-none">
                      <div id="accordion-05-heading-01" class="u-accordion__header g-pa-20" role="tab">
                        <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700">
                          ...
                          <a class="d-flex g-color-white g-text-underline--none--hover" href="#accordion-05-body-01"
                      ...
                      <div id="accordion-05-body-01" class="collapse show" role="tabpanel" aria-labelledby="accordion-05-heading-01" data-parent="#accordion-05">
                    ...
                    <div class="card rounded-0 g-bg-primary g-color-white g-brd-none">
                      <div id="accordion-05-heading-02" class="u-accordion__header g-pa-20" role="tab">
                        <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700">
                          ...
                          <a class="d-flex collapsed g-color-white g-text-underline--none--hover" href="#accordion-05-body-02"
                    ...
                    <div class="card rounded-0 g-bg-primary-dark-v2 g-color-white g-brd-none">
                      <div id="accordion-05-heading-03" class="u-accordion__header g-pa-20" role="tab">
                        <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700">
                          ...
                          <a class="d-flex collapsed g-color-white g-text-underline--none--hover" href="#accordion-05-body-03"
                  ...
                  <div class="card rounded-0 g-bg-primary g-color-white g-brd-none">
                    <div id="accordion-05-heading-04" class="u-accordion__header g-pa-20" role="tab">
                      <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700">
                        ...
                        <a class="d-flex collapsed g-color-white g-text-underline--none--hover" href="#accordion-05-body-04"
                    ...
                    <div class="card rounded-0 g-bg-gray-light-v4 g-brd-none">
                      <div id="accordion-06-heading-01" class="u-accordion__header g-pa-20" role="tab">
                        <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700">
                          ...
                          <a class="d-flex justify-content-between g-color-main g-text-underline--none--hover" href="#accordion-06-body-01"
                    ...
                    <div class="card rounded-0 g-bg-gray-light-v3 g-brd-none">
                      <div id="accordion-06-heading-02" class="u-accordion__header g-pa-20" role="tab">
                        <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700">
                          ...
                          <a class="collapsed d-flex justify-content-between g-color-main g-text-underline--none--hover" href="#accordion-06-body-02"
                    ...
                    <div class="card rounded-0 g-bg-gray-light-v4 g-brd-none">
                      <div id="accordion-06-heading-03" class="u-accordion__header g-pa-20" role="tab">
                        <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700">
                          ...
                          <a class="collapsed d-flex justify-content-between g-color-main g-text-underline--none--hover" href="#accordion-06-body-03"
                  ...
                  <div class="card rounded-0 g-bg-gray-light-v3 g-brd-none">
                    <div id="accordion-06-heading-04" class="u-accordion__header g-pa-20" role="tab">
                      <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700">
                        ...
                        <a class="collapsed d-flex justify-content-between g-color-main g-text-underline--none--hover" href="#accordion-06-body-04"
                      ...
                      <div class="card rounded-0 g-brd-none">
                        <div id="accordion-07-heading-03" class="u-accordion__header g-pa-0" role="tab">
                          <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700 g-pa-20a mb-0">
                            ...
                            <a class="collapsed d-flex g-color-main g-text-underline--none--hover" href="#accordion-07-body-03"
                      ...
                      <div class="card g-rounded-50 g-overflow-hidden g-brd-none mb-2">
                        <div id="accordion-08-heading-01" class="u-accordion__header g-pa-0" role="tab">
                          <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700 g-pa-20a mb-0">
                            ...
                            <a class="d-flex g-color-main g-text-underline--none--hover" href="#accordion-08-body-01"
                        ...
                        <div id="accordion-08-body-01" class="collapse show" role="tabpanel" aria-labelledby="accordion-08-heading-01" data-parent="#accordion-08">
                          <div class="u-accordion__body g-bg-gray-light-v5 g-px-50 g-py-30">
                            This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the details, it's time to get things mapped out and organized. This part is really crucial
                            in keeping the project in line to completion.
                          </div>
                      ...
                      <div class="card g-rounded-50 g-overflow-hidden g-brd-none mb-2">
                        <div id="accordion-08-heading-02" class="u-accordion__header g-pa-0" role="tab">
                          <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700 g-pa-20a mb-0">
                            ...
                            <a class="collapsed d-flex g-color-main g-text-underline--none--hover" href="#accordion-08-body-02"
                      ...
                      <div class="card g-rounded-50 g-overflow-hidden g-brd-none mb-2">
                        <div id="accordion-08-heading-03" class="u-accordion__header g-pa-0" role="tab">
                          <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700 g-pa-20a mb-0">
                            ...
                            <a class="collapsed d-flex g-color-main g-text-underline--none--hover" href="#accordion-08-body-03"
                        ...
                        <div id="accordion-08-body-03" class="collapse" role="tabpanel" aria-labelledby="accordion-08-heading-03" data-parent="#accordion-08">
                          <div class="u-accordion__body g-bg-gray-light-v5 g-px-50 g-py-30">
                            This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the details, it's time to get things mapped out and organized. This part is really crucial
                            in keeping the project in line to completion.
                          </div>
                ...
                <div class="shortcode-html">
                  <div id="accordion-09" class="u-accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="card rounded-0 g-brd-none">
                      ...
                      <div id="accordion-09-body-03" class="collapse" role="tabpanel" aria-labelledby="accordion-09-heading-03" data-parent="#accordion-09">
                        <div class="u-accordion__body g-color-gray-dark-v5 g-px-0 g-py-5">
                          This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the details, it's time to get things mapped out and organized. This part is really crucial
                          in keeping the project in line to completion.
                        </div>
                    ...
                    <div class="card rounded-0 g-brd-none">
                      <div id="accordion-10-heading-01" class="u-accordion__header g-pa-0" role="tab">
                        <h5 class="mb-0 g-font-weight-600 g-font-size-default">
                          ...
                          <a class="d-flex justify-content-between g-color-main g-text-underline--none--hover g-brd-bottom g-brd-gray-light-v4 g-pa-15-0" href="#accordion-10-body-01"
                    ...
                    <div class="card rounded-0 g-brd-none">
                      <div id="accordion-10-heading-02" class="u-accordion__header g-pa-0" role="tab">
                        <h5 class="mb-0 g-font-weight-600 g-font-size-default">
                          ...
                          <a class="collapsed d-flex justify-content-between g-color-main g-text-underline--none--hover g-brd-bottom g-brd-gray-light-v4 g-pa-15-0" href="#accordion-10-body-02"
                            ...
                            <span class="d-flex">
                              ...
                              <i class="icon-finance-168 u-line-icon-pro g-font-size-18 mr-3"></i>
                    ...
                    <div class="card rounded-0 g-brd-none">
                      <div id="accordion-10-heading-03" class="u-accordion__header g-pa-0" role="tab">
                        <h5 class="mb-0 g-font-weight-600 g-font-size-default">
                          ...
                          <a class="collapsed d-flex justify-content-between g-color-main g-text-underline--none--hover g-brd-bottom g-brd-gray-light-v4 g-pa-15-0" href="#accordion-10-body-03"
                            ...
                            <span class="d-flex">
                              ...
                              <i class="icon-finance-189 u-line-icon-pro g-font-size-18 mr-3"></i>
            ...
            <div class="shortcode-html">
              <div id="accordion-13" class="text-uppercase u-accordion" role="tablist" aria-multiselectable="true">
                ...
                <div class="card g-brd-none rounded-0 g-mb-1">
                  ...
                  <div id="accordion-13-body-01" class="collapse show g-bg-gray-dark-v1 g-color-white" role="tabpanel" aria-labelledby="accordion-13-heading-01" data-parent="#accordion-13">
                ...
                <div class="card g-brd-none rounded-0 g-mb-1">
                  ...
                  <div id="accordion-13-body-02" class="collapse g-bg-gray-dark-v1 g-color-white" role="tabpanel" aria-labelledby="accordion-13-heading-02" data-parent="#accordion-13">
                    <div class="u-accordion__body g-color-white-opacity-0_8">
                      All right Reserved.
                    </div>
                  </div>
                ...
                <div class="card g-brd-none rounded-0 g-mb-1">
                  ...
                  <div id="accordion-13-body-03" class="collapse g-bg-gray-dark-v1 g-color-white" role="tabpanel" aria-labelledby="accordion-13-heading-03" data-parent="#accordion-13">
                    <div class="u-accordion__body g-color-white-opacity-0_8">
                      All right Reserved.
                    </div>
                  </div>
                ...
                <div class="shortcode-html">
                  <div id="accordion-01" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="card g-mb-5">
                      ...
                      <div id="accordion-01-body-01" class="collapse show" role="tabpanel" aria-labelledby="accordion-01-heading-01" data-parent="#accordion-01">
                    ...
                    <div class="card g-mb-5">
                      ...
                      <div id="accordion-01-body-02" class="collapse" role="tabpanel" aria-labelledby="accordion-01-heading-02" data-parent="#accordion-01">
                        <div class="card-block">
                          This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the details, it's time to get things mapped out and organized. This part is really crucial
                          in keeping the project in line to completion.
                        </div>
                    ...
                    <div class="card g-mb-5">
                      ...
                      <div id="accordion-01-body-03" class="collapse" role="tabpanel" aria-labelledby="accordion-01-heading-03" data-parent="#accordion-01">
                        <div class="card-block">
                          This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the details, it's time to get things mapped out and organized. This part is really crucial
                          in keeping the project in line to completion.
                        </div>
                ...
                <div class="shortcode-html">
                  <div role="tablist" aria-multiselectable="true">
                    ...
                    <div class="card g-brd-0 g-mb-5">
                      ...
                      <div id="accordion-02-body-01" class="collapse show" role="tabpanel" aria-labelledby="accordion-02-heading-01" data-parent="#shortcode2">
                    ...
                    <div class="card g-brd-0 g-mb-5">
                      ...
                      <div id="accordion-02-body-02" class="collapse" role="tabpanel" aria-labelledby="accordion-02-heading-02" data-parent="#shortcode2">
                        <div class="card-block g-px-0">
                          This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the details, it's time to get things mapped out and organized. This part is really crucial
                          in keeping the project in line to completion.
                        </div>
                    ...
                    <div class="card g-brd-0 g-mb-5">
                      ...
                      <div id="accordion-02-body-03" class="collapse" role="tabpanel" aria-labelledby="accordion-02-heading-03" data-parent="#shortcode2">
                        <div class="card-block g-px-0">
                          This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the details, it's time to get things mapped out and organized. This part is really crucial
                          in keeping the project in line to completion.
                        </div>
...
Copy code
    ...
    <section class="container-fluid g-px-0">
<section class="container g-pt-0 g-pb-40">
        <div class="row">
          <div class="col-md-6 g-mb-60">
            <!-- Accordion v1 -->
                      ...
                      <div id="accordion-11-body-01" class="collapse" role="tabpanel" aria-labelledby="accordion-11-heading-01" data-parent="#accordion-11">
                        <div class="u-accordion__body g-color-gray-dark-v5">
                           <address class="g-line-height-2">
                            ...
                            <strong>Contacto:</strong> Jhon Doe
                            <br>
                              <i class="fas fa-phone-volume"></i>
                              <strong>Teléfono:</strong> (123) 456-7700
                              <br>
                               <i class="fas fa-clipboard"></i>
                             <strong>Informe emitido:</strong> 24-05-2019
                                       <br>
                                  <i class="fas fa-clipboard-list"></i>
                                 <strong>Informe generado:</strong> 24-05-2019
                            </address>
                        </div>
                      </div>
                    </div>
              ...
              <div id="shortcode12">
                <div class="shortcode-html">
                  ...
                  <div class="card g-brd-teal rounded-0">
                    <div class="card-block">
                      <p class="card-text">Utilizamos criterios en base a valores ajustados a la industria y
                      estándares internacionales del World Wide Web
                      Consortium, a demás de tendencias aceptadas a nivel mundial como las reglas de usabilidad de Jakob Nielsen y normas ISO relacionadas, 
