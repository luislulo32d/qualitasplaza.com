...
<head>
    <!-- Title -->
  <title>Qualitas Plaza - Blog</title>
  <link rel="canonical" href="https://qualitasplaza.com/blog.html">
        ...
        <div class="row d-flex justify-content-center align-content-end flex-wrap g-min-height-100">
          <div class="col-lg-7 mt-auto">
            <div class="mb-20">
              ...
              <br>
              <br>
              <h1 class="g-color-white g-font-weight-600 g-mb-30">Blog</h1>
            </div>
            <ul class="u-list-inline">
              <li class="list-inline-item g-mr-5">
                <a class="u-link-v5 g-color-white-opacity-0_7 g-font-weight-300 g-font-size-15 g-color-primary--hover"
                  href="https://qualitasplaza.com/">Home</a>
                <i class="g-color-white-opacity-0_7 g-font-weight-300">/</i>
              </li>
              <li class="list-inline-item g-mr-5">
                <a class="u-link-v5 g-color-white-opacity-0_7 g-font-weight-300 g-font-size-15 g-color-primary--hover"
