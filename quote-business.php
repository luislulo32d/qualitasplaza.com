...
<head>
  ...
  <title>Qualitas Plaza - Quote - Business Tools</title>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7 align-self-center g-color-white">
                        <div class="g-px-50--lg">
                         ...
                         REQUEST YOUR QUOTE FOR BUSINESS PLAN.</h2>
                          <p class="lead g-color-white-opacity-0_8 g-mb-35">Our experts will send you the best option to evaluate your needs and cover your requirements.</p>
                        </div>
                      </div>
...
<input type="hidden" id="_agile_form_id_tags" name="tags" value="cotizacion-business-eng">
     ...
     <input type="hidden" id="_agile_form_id" name="_agile_form_id" value="5699190361423872">
</div>
<!-- Text input-->
