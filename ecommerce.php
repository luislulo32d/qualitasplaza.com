...
<head>
  ...
  <link rel="canonical" href="https://qualitasplaza.com/ecommerce.html">
  ...
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall "
      ...
      <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_3--after"
        style="height: 140%; background-image: url(assets/img-temp/ecommerce.jpg);"></div>
      <!-- End Parallax Image -->
    ...
    <div class="container">
      ...
      <div class="shortcode-html g-mt-60">
        <div class="row">
          ...
          <div class="col-lg-6 align-self-center">
            <img class="img-fluid" src="assets/img-temp/sello2.png" alt="Image Description">
          </div>
        </div>
      </div>
      ...
      <div class="shortcode-html">
        <div id="accordion-07" class="u-accordion u-accordion-color-primary g-mb-50" role="tablist"
