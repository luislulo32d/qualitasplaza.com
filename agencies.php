...
<head>
  ...
  <link rel="canonical" href="https://qualitasplaza.com/agencies.html">
...
<body>
  <main>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall " data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
      <!-- Parallax Image -->
      <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_3--after" style="height: 140%; background-image: url(assets/img-temp/foto2.jpg);"></div>
      <!-- End Parallax Image -->

      <!-- Promo Block Content -->
      <div class="container g-color-white text-center g-py-120">
        <h3 class="h1 g-font-weight-600 text-uppercase mb-2">Agencies</h3>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="u-heading-v2-3--bottom g-brd-primary g-mb-30">
                    <h2 class="h3 text-uppercase g-font-weight-300 u-heading-v2__title">Specially for digital marketing companies, advertising agencies and consultants.</h2>
                  </div>
                  <p class="lead">Also ideal for entrepreneurs and consultants as it facilitates greater sales by ensuring the quality of their service at delivery.</p>
                </div>

                <div class="col-md-6">
                  <center>
                    <img class="img-fluid" src="assets/img-temp/others/agencies.jpg" width="80%" alt="Image Description">
                  </center>
                </div>
              </div>
            </div>
            ...
            <div class="shortcode-html">
              <header class="text-center g-mb-60 g-mt-70">
                <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                  <h2 class="h3 text-uppercase g-font-weight-300 u-heading-v2__title">Advantages for agencies program:</h2>
                </div>
              </header>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <ul class="list-unstyled g-mb-30 g-mb-0--sm">
                        <li class="d-flex g-mb-10">
                          ...
                          Validate clients and cluster web platforms.
                        </li>
                        <li class="d-flex g-mb-10">
                          <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i>
                          Check and ensure higher quality for customers' businesses.
                        </li>
                        <li class="d-flex g-mb-10">
                          <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i>
                          Genuine loyalty! Strengthen ties with real and potential clients.
                        </li>
                      </ul>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <ul class="list-unstyled">
                        ...
                        <li class="d-flex g-mb-10">
                          <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i>
                          Guarantee impartiality with an external and independent company.
                        </li>
                        <li class="d-flex g-mb-10">
                          <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i>
                          Differentiation: win customers with robust budgets.
                        </li>
                      </ul>
                    </div>
                  </div>
...
<!-- Form Name -->
<legend>Agencies - Quality Leaders</legend>
<p class="agile-form-description"></p>
<div style="display: none; height: 0px; width: 0px;">
<input type="hidden" id="_agile_form_name" name="_agile_form_name" value="Agencies - Quality Leaders">
...
<input type="hidden" id="_agile_form_id_tags" name="tags" value="agencia-eng">

<input type="hidden" id="_agile_form_id" name="_agile_form_id" value="5672846541979648">
</div>
<!-- Text input-->
...
<div class="agile-group">
  ...
  <div class="agile-field-xlarge agile-field">
    <div class="agile-input-group">
      <span class="agile-group-addon">URL</span>
      <input maxlength="250" id="agilefield-5" name="note" class="agile-field-xlarge agile-height-default" placeholder="Enter URL" type="text">
    </div>
  </div>
  <div class="agile-custom-clear"></div>
</div>
