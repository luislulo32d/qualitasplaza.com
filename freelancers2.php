...
<head>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <!-- Title -->
  <title>Qualitas Plaza - Program for Freelancers2</title>
  <link rel="canonical" href="https://qualitasplaza.com/freelancers2.php">
...
<body>
  <main>
          ...
          <div class="container no-margin">
            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
              <ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
                  ...
                  <li class="hs-has-mega-menu nav-item active g-mx-10--lg g-mx-15--xl" data-animation-in="fadeIn" data-animation-out="fadeOut" data-max-width="100%" data-position="right">
                    <a id="mega-menu-home" class="nav-link g-py-7 g-px-0" href="#!" aria-haspopup="true" aria-expanded="false">Account <i class="icon-user"></i>
            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
              <ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
                <!-- Home -->
                <li class="hs-has-mega-menu nav-item active g-mx-10--lg g-mx-15--xl" data-animation-in="fadeIn" data-animation-out="fadeOut" data-max-width="100%" data-position="right">
                  <a id="mega-menu-home" class="nav-link g-py-7 g-px-0" href="#!" aria-haspopup="true" aria-expanded="false"><img src="assets/img-temp/english.png" width="30px">
                  <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-7"></i></a>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall " data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
      <!-- Parallax Image -->
      <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_3--after" style="height: 140%; background-image: url(assets/img-temp/foto4.jpg);"></div>
      <!-- End Parallax Image -->

      <!-- Promo Block Content -->
      <div class="container g-color-white text-center g-py-120">
        <h3 class="h1 g-font-weight-600 text-uppercase mb-2">Freelancers</h3>
        <p class="g-font-weight-300 g-font-size-22 text-uppercase">Sign in</p>
      </div>
      <!-- Promo Block Content -->
    </section>
    <!-- End Promo Block -->
  <div class="container">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="u-heading-v2-3--bottom g-brd-primary g-mb-30">
                    <h2 class="h3 text-uppercase g-font-weight-300 u-heading-v2__title">Specially for SEO specialists, consultants and digital professions.</h2>
                  </div>
                  <p class="lead">Also ideal for entrepreneurs in the digital area as it facilitates hiring and allows greater sales by ensuring the quality of its services in delivery.</p>
                </div>

                <div class="col-md-6">
                  <center>
                    <img class="img-fluid" src="assets/img-temp/others/freelancers.jpg" width="80%" alt="Image Description">
                  </center>
                </div>
              </div>
            </div>
            ...
            <div class="shortcode-html">
              <header class="text-center g-mb-60 g-mt-70">
                <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                  <h2 class="h3 text-uppercase g-font-weight-300 u-heading-v2__title">Advantages for this program</h2>
                </div>
              </header>
                    ...
                    <div class="col-sm-6">
                      <ul class="list-unstyled g-mb-30 g-mb-0--sm">
                        <li class="d-flex g-mb-10">
                          ...
                          Validate the Web platforms at your expense.
                        </li>
                        <li class="d-flex g-mb-10">
                          <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i>
            ...
            <div class="shortcode-html g-mt-100">
              <!-- Icon Blocks -->
              <div class="row">
                <div class="col-lg-6 g-pb-40">
                  <h2 class="h3 g-font-weight-600 text-uppercase mb-0">Quality Leaders License.</h2>
                  <span class="d-block g-color-primary g-font-weight-300 g-font-size-20 g-mb-30">Exclusive agreement for programmers.</span>
                  <div class="row">
                    <div class="col-md-4 g-mb-30 g-mb-0--md">
                      <!-- Icon Blocks -->
                      <div class="borde-fondo text-center g-rounded-10 g-py-25">
                ...
                <div class="col-lg-6 g-pb-40">
                  ...
                  <div class="media g-mb-20">
                    <div class="d-flex mr-4">
                      <span class="u-icon-v3 u-icon-size--lg borde-fondo g-rounded-10">
                        <i class="icon-finance-254"></i>
                      </span>
                    </div>
                    <div class="media-body">
                      <h3 class="h5 g-mb-5">You will get:</h3>
                      <p>A Web tech plan yearly. Includes: Complete technical report and Web Quality Validation.</p>
                    </div>
                  </div>
                  <!-- End Icon Blocks -->
                  ...
                  <div class="media g-mb-20">
                    ...
                    <div class="media-body">
                      <h3 class="h5 g-mb-5">License</h3>
                      <p>You will receive a Web TECH Plan at no cost to each client for three months.</p>
                    </div>
                  </div>
                  <!-- End Icon Blocks -->
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h3 class="h5 g-mb-5">Affiliate program</h3>
                      <p>Receive a 20% commission or discount and many more advantages for your network.</p>
                    </div>
                  </div>
                  <!-- End Icon Blocks -->
                </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7 align-self-center g-color-white">
                        <div class="g-px-50--lg">
                          <h2 class="g-color-white g-font-weight-600 g-font-size-30 g-font-size-50--md text-uppercase g-line-height-1_2 g-mb-20">REQUEST A QUALITY LEADERS LICENSE FILLING THE FORM.</h2>
                          <p class="lead g-color-white-opacity-0_8 g-mb-35">Sign up to enter the special program and get the benefits of the service.</p>
                        </div>
                      </div>
...
<!-- Form Name -->
<legend>Freelancers - Quality Leaders</legend>
<p class="agile-form-description"></p>
<div style="display: none; height: 0px; width: 0px;">
<input type="hidden" id="_agile_form_name" name="_agile_form_name" value="Freelancers - Quality Leaders">
...
<input type="hidden" id="_agile_form_id_tags" name="tags" value="freelancer-eng">

<input type="hidden" id="_agile_form_id" name="_agile_form_id" value="5739901014245376">
</div>
<!-- Text input-->
...
<h4 style="text-align:left" class="agile-header-element">URL register</h4>
</div>
<div class="agile-group">
<p class="agile-text-element" style="text-align:left ;font-size:13px "> Enter the URLs where you want to apply the program.</p>
</div>


<!-- Prepended text-->
<div class="agile-group required-control">
  <label class="agile-label" for="agilefield-3">Website 1<span class="agile-span-asterisk"> *</span></label>
  <div class="agile-field-xlarge agile-field">
    <div class="agile-input-group">
      <span class="agile-group-addon">URL</span>
      <input maxlength="250" id="agilefield-3" name="website" class="agile-field-xlarge agile-height-default" placeholder="Enter URL" type="text" required="">
    </div>
  </div>
  <div class="agile-custom-clear"></div>
</div>
<!-- Prepended text-->
<div class="agile-group">
  <label class="agile-label" for="agilefield-4">Website 2</label>
  <div class="agile-field-xlarge agile-field">
    <div class="agile-input-group">
      <span class="agile-group-addon">URL</span>
      <input maxlength="250" id="agilefield-4" name="note" class="agile-field-xlarge agile-height-default" placeholder="Enter URL" type="text">
    </div>
  </div>
  <div class="agile-custom-clear"></div>
</div>
<!-- Prepended text-->
<div class="agile-group">
  <label class="agile-label" for="agilefield-5">Website 3</label>
  <div class="agile-field-xlarge agile-field">
    <div class="agile-input-group">
      <span class="agile-group-addon">URL</span>
      <input maxlength="250" id="agilefield-5" name="agilefield-5" class="agile-field-xlarge agile-height-default" placeholder="Enter URL" type="text">
    </div>
  </div>
  <div class="agile-custom-clear"></div>
</div>
<div class="agile-group">
<p class="agile-text-element" style="text-align:center ;font-size:11px ">In compliance with Data Protection Law, we inform you that you have the right to withdraw your consents at any time, as well as to oppose the treatment, limit it, access, rectify, delete data and exercise your right to portability, through the email info@qualitasplaza.com.</p>
</div>
...
<div class="agile-group">
  ...
  <div class="agile-field agile-button-field">
    <button type="submit" class="agile-button">Request license</button>
          ...
          <div class="shortcode-html">
            ...
            <footer class="g-bg-bluegray-lineargradient g-color-white-opacity-0_8 g-bg-img-hero g-pt-60">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                    <div class="u-heading-v2-3--bottom g-brd-white-opacity-0_8 g-mb-20">
                      <h2 class="u-heading-v2__title h6 text-uppercase mb-0">OUR SERVICE</h2>
                    </div>

                    <div class="g-mb-30">
                      <p>Supervise, validate and improve the digital experience of your clients.</p>
                    </div>

                    <address class="mb-0">
                      <div class="g-mb-30">
                        <h4 class="h6 g-font-weight-600">Address</h4>
                       <p class="mb-0">Hyldegårds Tværsvej 47, 4tv. <br>2920 Charlottenlund. (Copenhagen) <br>Denmark.</p>
                      </div>

                      <div class="g-mb-30">
                        <h4 class="h6 g-font-weight-600">Phone</h4>
                      <p class="g-mb-2">Spain: (+34) 951 23.93.95</p>
                        <p class="g-mb-10">Denmark: (+45) 52.52.05.70</p>
                      </div>
              ...
              <div class="g-bg-black-opacity-0_1 g-color-white-opacity-0_8 text-center g-py-20">
                <div class="container">
                  <small class="g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">2020 © All Rights Reserved.
                  </small>
                </div>
              </div>
