...
<head>
  <!-- Title -->
  <title>Qualitas Plaza - No pierdas clientes</title>
  <link rel="canonical" href="https://qualitasplaza.com/qualitas-plaza-no-pierdas-clientes.html">
    ...
    <div class="container g-py-100">
      <div class="masonry-grid row g-mb-70">
        ...
        <div class="masonry-grid-item col-sm-6 g-mb-30">
          ...
          <article>
            <img class="img-fluid w-100" src="../../assets/img-temp/500x450/blog1.jpg" alt="incrementar ventas">
            <div class="g-width-80x g-bg-white g-pos-rel g-z-index-1 g-pa-30 g-mt-minus-50 mx-auto">
              ...
              <h2 class="h5 g-color-black g-font-weight-600 mb-3">
                ...
                <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer" href="#!">Qualitas Plaza, su
                  solución para dejar de perder clientes y aumentar las ventas.
                </a>
              ...
              <a class="g-font-size-13" href="#!">Ver más...</a>
            </div>
          </article>
        ...
        <div class="masonry-grid-item col-sm-6 g-mb-30">
          <!-- Blog Grid Overlap Blocks -->
          <article>
            <img class="img-fluid w-100" src="../../assets/img-temp/500x450/blog2.jpg" alt="perder clientes">
            <div class="g-width-80x g-bg-white g-pos-rel g-z-index-1 g-pa-30 g-mt-minus-50 mx-auto">
              <span class="d-block g-color-gray-dark-v4 g-font-weight-600 g-font-size-12 text-uppercase mb-2">11 ENE
                2019</span>
              <h2 class="h5 g-color-black g-font-weight-600 mb-3">

                <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer" href="#!">¿Cómo dejar de
                  perder clientes y aumentar las ventas? un caso de estudio real.</a>
