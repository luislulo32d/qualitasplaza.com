...
<head>
  ...
  <link rel="canonical" href="https://qualitasplaza.com/cotizacion-tool">
          ...
          <div class="col-lg-7 align-self-center g-color-white">
            <div class="g-px-50--lg">
              <h2
                ...
                Solicita tu presupuesto para el panel avanzado de negocios.</h2>
              ...
              <form class="form-view theme3" id="agile-form" action="https://qualitasplaza.agilecrm.com/formsubmit"
                ...
                <fieldset>
                  ...
                  <div style="display: none; height: 0px; width: 0px;">
                    ...
                    <input type="hidden" id="_agile_form_id" name="_agile_form_id" value="5648023073849344">
                  </div>
                  <!-- Text input-->
                  ...
                  <div class="agile-group">
                    <p class="agile-text-element" style="text-align:left ;font-size:12px ">Cuéntanos acerca de tu
                      proyecto:</p>
                  </div>
                  ...
                  <div class="agile-group">
                    ...
                    <div class="agile-field-xlarge agile-field">
                      <textarea maxlength="250" id="agilefield-5" name="note" placeholder=""
